...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		{			
			degreeSequence.add(this.getNeighbors(i).size()+this.getInNeighbors(i).size());
		}
	...
	public static void main (String[] args) {
		...
		System.out.println("Distance 2 of vetex 7 "+graphFromFile.getDistance2(7));
		System.out.println("Goal: implement method using two approaches.");
		
		System.out.println("The Adj Matrix :");
		System.out.println(graphAdjMatrix);
		System.out.println("Distance 2 of vetex 7 "+graphAdjMatrix.getDistance2(7));
		System.out.println("Goal: implement method using two approaches.");	
	}
}
